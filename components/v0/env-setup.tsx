      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Setup Required</h2>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">After adding the variables, restart your server</p>
          </div>
        </div>
      </div>
    </div>
