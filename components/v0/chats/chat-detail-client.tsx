...
import { type ImageAttachment, clearPromptFromStorage } from '@/components/v0/ai-elements/prompt-input'
...
export function ChatDetailClient() {
  ...
  return (
    <div className={cn('min-h-screen bg-gray-50 dark:bg-black', isFullscreen && 'fixed inset-0 z-50')}>
      <AppHeader />
