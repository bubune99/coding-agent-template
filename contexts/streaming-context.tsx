...
interface StreamingContextType {
  ...
  startHandoff: (chatId: string, stream: ReadableStream<Uint8Array>, userMessage: string) => void
  clearHandoff: () => void
}
...
export function StreamingProvider({ children }: StreamingProviderProps) {
  ...
  const startHandoff = (chatId: string, stream: ReadableStream<Uint8Array>, userMessage: string) => {
