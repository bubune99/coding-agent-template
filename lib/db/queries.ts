...
export async function createChatOwnership({ v0ChatId, userId }: { v0ChatId: string; userId: string }) {
  try {
    return await db
...
export async function createAnonymousChatLog({ ipAddress, v0ChatId }: { ipAddress: string; v0ChatId: string }) {
  try {
